...
const GadgetsCategories = ({categories}) => {
    return (
        <div className='grid lg:grid-cols-1 grid-cols-2 w-full items-start gap-6 p-3 lg:p-6 bg-white rounded-2xl mt-12 lg:mr-6'>
            ...
            {
                categories.map(category=><NavLink to={`/category/${category.category_name}`} 
