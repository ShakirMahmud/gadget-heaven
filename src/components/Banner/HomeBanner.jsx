...
const HomeBanner = () => {
    return (
        <div className='relative '>
            <div className='bg-banner outline outline-2 outline-offset-8 outline-[#F6F6F6]  rounded-[32px] w-[96.25%] mx-auto absolute  left-1/2 transform -translate-x-1/2 -translate-y-[12%] lg:-translate-y-[13%] z-0'>
                ...
                <img className='object-contain w-[90.25%] lg:w-auto mx-auto rounded-3xl outline outline-2 outline-offset-[12px] outline-[#F6F6F6] lg:h-[563px] absolute  left-1/2 transform -translate-x-1/2 translate-y-[170%] lg:translate-y-[70%]' src={banner} alt="" />
        </div>
    );
};
